package com.example.comp6239.helper;

/**
 * solve the problem of call and reuse of fragment
    ...
    private void doTabChanged(Tab<T> newTab, Tab<T> oldTab) {
        ...
        if (oldTab != null) {
            if (oldTab.fragment != null) {
                // remove from current page, but still in cache
        ...
        if (newTab != null) {
            if (newTab.fragment == null) {
                ...
                // move to FragmentManger
                ft.add(containerId, fragment, newTab.clx.getName());
            } else {
                // loading from cache of FragmentManger
